...
class Album(models.Model):
    title = models.CharField(max_length=255, default='Мій альбом')
    title_en = models.CharField(max_length=255, default='My album')
    title_ru = models.CharField(max_length=255, default='Мой альбом')
